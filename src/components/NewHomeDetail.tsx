  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className="w-full max-w-4xl max-h-[90vh] bg-gradient-to-b from-gray-900 to-black border border-orange-500/30 rounded-2xl overflow-hidden animate-slideIn">
          {/* 顶部导航 */}
          ...
          {/* 主要内容区 */}
          <div className="max-w-7xl mx-auto px-4 py-8 overflow-y-auto h-[calc(100vh-80px)]">
